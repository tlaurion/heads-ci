...
echo "###########" >> ./oem-provisioning.generated
echo "#The following GPG Key Admin PIN will be required from you to manage your HOTP compliant security key" >> ./oem-provisioning.generated
...
echo "#The following GPG Key User PIN will be required from you to Sign/Encrypt/Authenticate with your HOTP compliant security key" >> ./oem-provisioning.generated
...
echo "oem_gpg_real_name=$oem_gpg_real_name" >> ./oem-provisioning.generated
echo "oem_gpg_email=$oem_gpg_email" >> ./oem-provisioning.generated
...
echo "oem_gpg_comment=$oem_gpg_comment" >> ./oem-provisioning.generated
echo "#" >> ./oem-provisioning.generated
echo "########################################" >> ./oem-provisioning.generated
...
echo "oem_luks_actual_Disk_Recovery_Key=$oem_luks_actual_Disk_Recovery_Key" >> ./oem-provisioning.generated
...
echo "oem_luks_new_Disk_Recovery_Key=$(diceware -d " " -n 6)" >> ./oem-provisioning.generated
